    ...
    <div class="row">
        ...
        <div class="span4">
            ...
            <div class="well">
                ...
                <h5>VYTVOŘTE SI ÚČET</h5><br/>

                Zadajte váš email pre vytvorenie účtu.<br/><br/><br/>

                <form action="register.php">

                    <div class="control-group">

                        <label class="control-label" for="inputEmail0">Emailová adresa</label>
                    ...
                    <div class="controls">
                        ...
                        <button type="submit" class="btn block">Vytvoriť účet</button>
                ...
                <form>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <input type="password" class="span3" id="inputPassword1" placeholder="Heslo">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <button type="submit" class="btn">Prihlásiť sa</button> <a href="forgetpass.php">Zabudli ste heslo?</a>
